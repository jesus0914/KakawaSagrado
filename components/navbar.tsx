...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between p-4 cursor-pointer sm:max ">
      <h1 className=" text-3xl"onClick={()=>router.push("/")}>Kakawa
        <span className="font-bold">Sagrado</span>
      </h1>
