...
const  BannerDiscount  =() =>{
    return(
        <div className="p-5 sm:p-20 text-center">
            ...
            <h3 className="mt-3 font-semibold">-20% al gastar $ 100  o -25% al gastar $ 150. Usa el codigo de Kakawa Sagrado</h3>
        
            <div className="max-w-md mx-auto sm:flex justify-center gap-8 mt-5">
                <Link href="#" className={buttonVariants()}>Comparar</Link>
